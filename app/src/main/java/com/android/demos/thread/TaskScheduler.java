package com.android.demos.thread;
...
public class TaskScheduler {
    ...
    public static void executeAtUI(final Object object, final Runnable backgroundRunnable, final Runnable postExecuteRunnable) {
        ...
        new AsyncTask<Object, Object, Object>() {
            ...
            protected void onCancelled() {
                Log.d(TAG, String.format("AsyncTask onCancelled class=%s", backgroundRunnable.getClass().getName()));
                if (postExecuteRunnable != null) {
                    postExecuteRunnable.run();
                }
            }
     ...
     * @param <Output> 输出参数类型
     */
    public abstract static class Task<Input, Output> extends AsyncTask<Input, Object, Output> {
